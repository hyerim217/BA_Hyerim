...
#         print "CDF: ", multinomCDF(num_categories, num, p, [num]+count[1:])
    ...
    # Generate Colored list with output ranking. Different Groups are in differnt colors
    document = Document()
...
test_ranking = generate_ranking(data_set, attribute, 'Quality',50, [0.4,0.3,0.3], 0.1, True)